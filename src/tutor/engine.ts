    ...
    content: [
      {
        type: "text",
        text:
          "[SYSTEM NOTE — this is NOT from the student; the student has NOT answered anything. " +
          `The picture below was just generated by the app at YOUR request (you asked for: "${scenePrompt}") ` +
          "so you can show it and ask about it. Do NOT treat this image as the student's work or answer. " +
